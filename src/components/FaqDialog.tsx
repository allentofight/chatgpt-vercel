...
export default function FAQDialog(props: { closeDialog: () => void }) {
    let faqs = [
        {
        ...
        },
        {
            ...
            answer: createMemo(() => (
                <>
                    因为当前官方限制了对免费 api key
                    的使用，为了保证回答问题的速度，站主自掏腰包去买了官方不限速的付费
                    api
                    key，再加上为了维持网站的正常经营需要购买服务器，数据库等，这一个月下来是笔不小的支出，为爱发电不可持续，所以需要收费
                </>
            )),
        },
        {
            ...
            answer: createMemo(() => (
                <>
                    非常合理，目前市面上多数按字数收费，多数在 5000 字 28
                    元左右, 而我们网站是包月
                    <span style="color:red;">不限次数</span>
                    ！市面上可以说是独此一家了，目前是试运营阶段，包月不限次数很可能会超支，后期可能会涨价，提前续费后期也可以不限字数哦
                </>
            )),
        },
        {
        ...
        },
        {
            ...
            answer: createMemo(() => (
                <>
                    ...
                    <br />
                    <br />
                    1.独享的加速通道，与官方 PLUS 用户输出速度一样快，与 PLUS
                    会员一样可使用 GPT 3.5, GPT 4o
                    <br />
                    2.永久的会话数据保存
                    <br />
                    3. 后期会集成 AI 绘画，也会一起开放给会员使用
                    <br />
                </>
            )),
        },
