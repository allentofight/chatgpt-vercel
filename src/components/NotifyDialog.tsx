...
const NotifyDialog = () => {
  ...
  const handleInvite = async () => {
    ...
    if (sessionId) {
      window.location.href = `https://www.nextaibots.com?sid=${sessionId}`;
    } else {
      window.location.href = `https://www.nextaibots.com/login`;
    }
  };
    ...
    <div>
      <div class="fixed inset-0 flex items-center justify-center z-102">
        <div class="bg-white w-96 p-8 rounded-lg relative">
          <p class="mb-6">网站已切换至 <span class="text-blue-500">https://www.nextaibots.com</span></p>
          <button
