        ...
        <>
            ...
            <Show when={showDialog()}>
                <div class="flex flex-col items-end fixed bottom-48 right-3 hidden">
                    <img src="https://b1.beisheng.com/common/starchain_self_image/2308/08/close.png" onClick={() => {
                        closeDialog()
                    }} />
                    <img class="mt-2 activity rounded" src="https://b1.beisheng.com/common/starchain_self_image/2308/08/img_v2_2af28970-a500-40f3-b116-b2bf4b5dee0g.jpg"
                        onClick={() => {
